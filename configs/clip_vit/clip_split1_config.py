...
model = dict(
    type='CapeXModel',
    pretrained='vit-base-patch16-224',  # vit-base-16-224 for img_feature extraction
    text_pretrained="ViT-B/32",  # clip-vit-B/32-224
