...
def main():
    ...
    res_folder = os.path.dirname(args.checkpoint)
    eval_config['res_folder'] = res_folder
    ...
    if rank == 0:
        ...
        # save testing log
        test_log = os.path.join(res_folder, f"test_log_{os.path.splitext(os.path.basename(args.config))[0]}.txt")
