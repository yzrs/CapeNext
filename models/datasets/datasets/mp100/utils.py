def rename_points_descriptions(category, test_type="regular_test"):
    if test_type is None or test_type == "regular_test":
    ...
    elif test_type == "no_position_test":
        return no_position_descriptions(category)
    elif test_type == "manual_modification":
        return manual_modification_v0(category)
    elif test_type == "manual_modification_v1":
        return manual_modification_v1(category)
    elif test_type == "manual_modification_paw":
        return manual_modification_paw(category)
    elif test_type == "manual_modification_eye":
        return manual_modification_eye(category)
    elif test_type == "manual_modification_elbow":
        return manual_modification_elbow(category)
    elif test_type == "manual_modification_shoulder":
        return manual_modification_shoulder(category)
    else:
        raise ValueError("Invalid test_type: {}".format(test_type))
...
def manual_modification_v0(category):
    updated_point_names = []
    if category['supercategory'] == 'animal_face':
        updated_point_names = ['top left side of the left eye', 'bottom right side of the left eye',
                               'bottom left side of the right eye', 'top right side of the right eye',
    ...
    elif category['id'] == 18: # person face
        updated_point_names = ['left side of the left eyebrow', 'middle side of the left eyebrow',
                               'right side of the left eyebrow', 'left side of the right eyebrow',
                               'middle side of the right eyebrow', 'right side of the right eyebrow',
                               'left side of the left eye', 'middle side of the left eye', 'right side of the left eye',
        ...
        for i, prompt in enumerate(updated_point_names):
            if 'paw' in prompt:
                updated_point_names[i] = prompt.replace('paw', 'foreleg')
        # print("{} category {} of {} already has its keypoint prompt".format(category['id'],
        #                                                                     category['name'],
        #                                                                     category['supercategory']))
        # print(updated_point_names)

    return updated_point_names

def manual_modification_v1(category):
    updated_point_names = []
    if category['supercategory'] == 'animal_face':
        updated_point_names = ['top left side of the left eye', 'bottom right side of the left eye',
                               'bottom left side of the right eye', 'top right side of the right eye',
        ...
        for i, prompt in enumerate(updated_point_names):
            if 'paw' in prompt:
                updated_point_names[i] = prompt.replace('paw', 'foot')
            if 'eye' in prompt:
                updated_point_names[i] = prompt.replace('eye', 'eyeball')
            if 'elbow' in prompt:
                updated_point_names[i] = prompt.replace('elbow', 'forearm')
            if 'shoulder' in prompt:
                updated_point_names[i] = prompt.replace('shoulder', 'upper arm')
...
def manual_modification_paw(category):
    updated_point_names = []
    if category['supercategory'] == 'animal_face':
        updated_point_names = ['top left side of the left eye', 'bottom right side of the left eye',
                               'bottom left side of the right eye', 'top right side of the right eye',
...
def manual_modification_eye(category):
    updated_point_names = []
    if category['supercategory'] == 'animal_face':
        updated_point_names = ['top left side of the left eye', 'bottom right side of the left eye',
                               'bottom left side of the right eye', 'top right side of the right eye',
...
def manual_modification_elbow(category):
    updated_point_names = []
    if category['supercategory'] == 'animal_face':
        updated_point_names = ['top left side of the left eye', 'bottom right side of the left eye',
                               'bottom left side of the right eye', 'top right side of the right eye',
...
def manual_modification_shoulder(category):
    updated_point_names = []
    if category['supercategory'] == 'animal_face':
        updated_point_names = ['top left side of the left eye', 'bottom right side of the left eye',
                               'bottom left side of the right eye', 'top right side of the right eye',
...
def no_position_descriptions(category):
    updated_point_names = []
    if category['name'] in ['antelope_body', 'beaver_body', 'bison_body', 'bobcat_body', 'cat_body', 'cheetah_body',
        ...
        updated_point_names = ['eye 1', 'eye 2', 'nose', 'neck', 'base of the tail', 'shoulder 1',
                               'elbow 1', 'paw 1', 'shoulder 2', 'elbow 2', 'paw 2',
                               'hip 1', 'knee 1', 'paw 3', 'hip 2', 'knee 2', 'paw 4']
    elif category['name'] in ["human_body", "person", "macaque"]:
        updated_point_names = ['nose', 'eye 1', 'eye 2', 'ear 1', 'ear 2', 'shoulder 1',
                               'shoulder 2', 'elbow 1', 'elbow 2', 'wrist 1', 'wrist 2',
                               'hip 1', 'hip 2', 'knee 1', 'knee 2', 'ankle 1', 'ankle 2']
    elif category['supercategory'] == 'bird':
        updated_point_names = ['back', 'beak', 'belly', 'chest', 'top of the head', 'forehead', 'eye 1', 'leg 1',
                               'wing 1', 'neck 1', 'eye 2', 'leg 2', 'wing 2', 'tail', 'neck 2']
    elif category['supercategory'] == 'animal_face':
        updated_point_names = ['side of the eye 1', 'side of the eye 2',
                               'side of the eye 3', 'side of the eye 4',
                               'nose tip', 'side of the lip 1', 'side of the lip 2', 'side of the lip 3',
                               'side of the lip 4']
    elif category['name'] == 'sofa':
        updated_point_names = ['leg 1', 'leg 2', 'side of the seat 1',
                               'side of the seat 2', 'side of the armrest 1',
                               'side of the armrest 2', 'side of the backrest 1',
                               'leg 3', 'leg 4', 'side of the seat 3',
                               'side of the seat 4', 'side of the armrest 3',
                               'side of the armrest 4', 'side of the backrest 2']
    elif category['name'] == 'chair':
        updated_point_names = ['leg 1', 'leg 2', 'leg 3',
                               'leg 4', 'side of the seat 1',
                               'side of the seat 2', 'side of the seat 3',
                               'side of the seat 4', 'side of the backseat 1',
                               'side of the backseat 2']
    elif category['name'] == 'bed':
        updated_point_names = ['left and back leg', 'left and front leg', 'left and back side of the mattress',
                               'left and front side of the mattress', 'top left side of the headboard',
                               'right and back leg', 'right and front leg', 'right and back side of the mattress',
        ...
        updated_point_names = ['wheel 1', 'wheel 2', 'wheel 3', 'wheel 4', 'wheel 5', 'center of the wheels',
                               'center of the seat', 'side of the seat 1',
                               'side of the seat 2', 'side of the seat 3',
                               'side of the seat 4', 'side of the backrest 1',
                               'side of the backrest 2']
    elif category['name'] == 'table':
        updated_point_names = ['side of the top 1', 'side of the top 2',
                               'side of the top 3', 'side of the top 4',
                               'leg 1', 'leg 2', 'leg 3',
                               'leg 4']
    elif category['supercategory'] == 'vehicle':
        # windshield is not present in the skeleton and should be ignored.
        updated_point_names = ['wheel 1', 'wheel 2', 'wheel 3',
                               'wheel 4', 'headlight 1', 'headlight 2', 'taillight 1',
                               'taillight 2', 'windshield', 'side of the top 1',
                               'side of the top 2', 'side of the top 3',
                               'side of the top 4']
    elif category['name'] == 'skirt':
        updated_point_names = ['side of the skirt 1', 'side of the skirt 2', 'side of the skirt 3',
                               'side of the skirt 4', 'side of the skirt 5', 'side of the skirt 6',
                               'side of the skirt 7', 'side of the skirt 8']
    elif category['name'] == 'short_sleeved_outwear':
        updated_point_names = ['collar 1', 'placket 1', 'collar 2',
                               'collar 3', 'collar 4', 'collar 5',
                               'the shoulder seam 1', 'sleeve 1', 'sleeve 2', 'sleeve 3',
                               'sleeve 4', 'sleeve 5', 'body of the shirt 1',
                               'body of the shirt 2', 'side of the shirt 1',
                               'side of the shirt placket 1', 'side of the shirt 2',
                               'body of the shirt 2', 'body of the shirt 3',
                               'sleeve 6', 'sleeve 7', 'sleeve 8', 'sleeve 9', 'sleeve 10',
                               'the shoulder seam 2', 'collar 6',
                               'side of the shirt placket 2', 'side of the shirt placket 3',
                               'side of the shirt placket 4', 'side of the shirt placket 5',
                               'side of the shirt placket 6']
    elif category['name'] == 'long_sleeved_outwear':
        updated_point_names = ['side of the collar 1', 'side of the collar 2', 'side of the collar 3', 'side of the placket 1',
                               'side of the collar 4', 'side of the collar 5',
                               'side of the shoulder seam 1', 'sleeve 1', 'sleeve 2', 'sleeve 3',
                               'sleeve 4', 'sleeve 5', 'sleeve 6', 'sleeve 7', 'sleeve 8', 'sleeve 9',
                               'body of the shirt 1',
                               'body of the shirt 2', 'side of the shirt 1',
                               'side of the shirt placket 1', 'side of the shirt 2',
                               'body of the shirt 3', 'body of the shirt 4',
                               'sleeve 10', 'sleeve 11', 'sleeve 12', 'sleeve 13', 'sleeve 14',
                               'sleeve 15', 'sleeve 16', 'sleeve 17', 'sleeve 18',
                               'side of the shoulder seam 2', 'side of the placket 2',
                               'side of the shirt placket 2', 'side of the shirt placket 3',
                               'side of the shirt placket 4', 'side of the shirt placket 5',
                               'side of the shirt placket 6']
    elif category['name'] == 'sling':
        updated_point_names = ['side of the collar 1', 'side of the collar 2', 'side of the collar 3',
                               'side of the collar 4', 'side of the collar 5', 'side of the collar 6',
                               'shoulder strap 1', 'body of the shirt 1', 'body of the shirt 2',
                               'side of the shirt 1', 'side of the shirt 2',
                               'side of the shirt 3', 'side of the shirt 4',
                               'side of the shirt 5', 'shoulder strap 2']

    elif category['name'] == 'sling_dress':
        updated_point_names = ['side of the collar 1', 'side of the collar 2', 'side of the collar 3',
                               'side of the collar 4', 'side of the collar 5', 'side of the collar 6',
                               'strap 1', 'body of the dress 1', 'body of the dress 2',
                               'body of the dress 3', 'side of the dress 1',
                               'side of the dress 2', 'side of the dress 3',
                               'side of the dress 4', 'side of the dress 5',
                               'body of the dress 3', 'body of the dress 4',
                               'body of the dress 5', 'strap 2']
    elif category['name'] == 'long_sleeved_dress':
        updated_point_names = ['side of the collar 1', 'side of the collar 2', 'side of the collar 3',
                               'side of the collar 4', 'side of the collar 5', 'side of the collar 6',
                               'side of the shoulder seam 1', 'sleeve 1', 'sleeve 2', 'sleeve 3',
                               'sleeve 4', 'sleeve 5', 'sleeve 6', 'sleeve 7',
                               'sleeve 8', 'sleeve 9', 'body of the dress 1',
                               'body of the dress 2', 'body of the dress 3',
                               'body of the dress 4', 'side of the dress 1',
                               'side of the dress 2', 'side of the dress 3',
                               'body of the dress 5', 'body of the dress 6',
                               'body of the dress 7', 'body of the dress 8',
                               'sleeve 10', 'sleeve 11', 'sleeve 12', 'sleeve 13', 'sleeve 14',
                               'sleeve 15', 'sleeve 16', 'sleeve 17', 'sleeve 18',
                               'side of the shoulder seam 2']
    elif category['name'] == 'short_sleeved_dress':
        updated_point_names = ['side of the collar 1', 'side of the collar 2', 'side of the collar 3',
                               'side of the collar 4', 'side of the collar 5', 'side of the collar 6',
                               'side of the shoulder seam 1', 'sleeve 1', 'sleeve 2', 'sleeve 3',
                               'sleeve 4', 'sleeve 5', 'body of the dress 1',
                               'body of the dress 2', 'body of the dress 3',
                               'body of the dress 4', 'side of the dress 1',
                               'side of the dress 2', 'side of the dress 3',
                               'body of the dress 5', 'body of the dress 6',
        ...
        updated_point_names = ['side of the collar 1', 'side of the collar 2', 'side of the collar 3',
                               'side of the collar 4', 'side of the collar 5', 'side of the collar 6',
                               'shoulder 1', 'body of the shirt 1', 'body of the shirt 2',
                               'side of the shirt 1', 'side of the shirt 2',
                               'side of the shirt 3', 'side of the shirt 4',
                               'side of the shirt 5', 'shoulder 2']
    elif category['name'] == 'vest_dress':
        updated_point_names = ['side of the collar 1', 'side of the collar 2', 'side of the collar 3',
                               'side of the collar 4', 'side of the collar 5', 'side of the collar 6',
                               'shoulder 1', 'body of the dress 1', 'body of the dress 2',
                               'body of the dress 3', 'body of the dress 4',
                               'side of the dress 1', 'side of the dress 2',
                               'side of the dress 3', 'side of the dress 4',
                               'side of the dress 5', 'side of the dress 6',
                               'side of the dress 7', 'shoulder 2']
    # here
    elif category['name'] == 'long_sleeved_shirt':
        updated_point_names = ['side of the collar 1', 'side of the collar 2', 'side of the collar 3',
                               'side of the collar 4', 'side of the collar 5', 'side of the collar 6',
                               'side of the shoulder seam 1', 'sleeve 1', 'sleeve 2', 'sleeve 3',
                               'sleeve 4', 'sleeve 5', 'sleeve 6', 'sleeve 7',
                               'sleeve 8', 'sleeve 9', 'body of the shirt 1',
                               'body of the shirt 2', 'side of the shirt 1',
                               'side of the shirt 2', 'side of the shirt 3',
                               'body of the shirt 3', 'body of the shirt 4',
                               'sleeve 10', 'sleeve 11', 'sleeve 12', 'sleeve 13', 'sleeve 14',
                               'sleeve 15', 'sleeve 16', 'sleeve 17', 'sleeve 18',
                               'side of the shoulder seam 2']
        ...
        updated_point_names = ['side of the pants 1', 'side of the pants 2', 'side of the pants 3',
                               'side of the pants 4', 'side of the leg opening 1',
                               'side of the leg opening 2', 'crutch', 'side of the leg opening 3',
                               'side of the leg opening 4', 'side of the pants 5']
    elif category['name'] == 'trousers':
        updated_point_names = ['side of the pants 1', 'side of the pants 2', 'side of the pants 3',
                               'side of the pants 4', 'side of the pants 5',
                               'side of the leg opening 1', 'side of the leg opening 2',
                               'side of the pants 6', 'crutch', 'side of the pants 7',
                               'side of the leg opening 3', 'side of the leg opening 4',
                               'side of the pants 8', 'side of the pants 9']
    elif category['name'] == 'short_sleeved_shirt':
        updated_point_names = ['side of the collar 1', 'side of the collar 2', 'side of the collar 3',
                               'side of the collar 4', 'side of the collar 5', 'side of the collar 6',
                               'side of the shoulder seam 1', 'sleeve 1', 'sleeve 2', 'sleeve 3',
        ...
        # human_face from 300W
        updated_point_names = ['side of cheek 1', 'side of cheek 2',
                               'side of cheek 3',
                               'side of the cheek 4', 'side of the cheek 5',
                               'side of the cheek 6',
                               'side of the jaw 1', 'side of the jaw 2',
                               'chin',
                               'side of the jaw 3', 'side of the jaw 4',
                               'side of the cheek 7', 'side of the cheek 8',
                               'side of the cheek 9',
                               'side of cheek 10', 'side of cheek 11',
                               'side of cheek 12',
                               'side of the eyebrow 1', 'side of the eyebrow 2',
                               'side of the eyebrow 3', 'side of the eyebrow 4',
                               'side of the eyebrow 5',
                               'side of the eyebrow 6', 'side of the eyebrow 7',
                               'side of the eyebrow 8', 'side of the eyebrow 9',
                               'side of the eyebrow 10',
                               'side of the nose 1', 'side of the nose 2', 'side of the nose 3',
                               'side of the nose 4',
                               'side of the nostril 1', 'side of the nostril 2',
                               'side of the nostrils 3',
                               'side of the nostril 4', 'side of the nostril 5',
                               'side of the eye 1',
                               'side of the eye 2', 'side of the eye 3',
                               'side of the eye 4',
                               'side of the eye 5', 'side of the eye 6',
                               'side of the eye 7',
                               'side of the eye 8', 'side of the eye 9',
                               'side of the eye 10',
                               'side of the eye 11', 'side of the eye 12',
                               'side of the lips 1', 'side of lip 2',
                               'side of lip 3', 'side of lip 4', 'side of lip 5',
                               'side of lip 6', 'side of the lips 7',
                               'side of the lip 8',
                               'side of the lip 9', 'side of the lip 10', 'side of the lip 11',
                               'side of the lip 12',
                               'side of the lips 13',
                               'side of lip 14', 'side of lip 15', 'side of lip 16',
                               'side of the lips 17',
                               'side of the lip 18', 'side of the lip 19', 'side of the lip 20'
                               ]
    elif category['id'] == 18:
        updated_point_names = ['side of the eyebrow 1', 'side of the eyebrow 2',
                               'side of the eyebrow 3', 'side of the eyebrow 4',
                               'side of the eyebrow 5', 'side of the eyebrow 6',
                               'side of the eye 1', 'side of the eye 2', 'side of the eye 3',
                               'side of the eye 4', 'side of the eye 5',
                               'side of the eye 6', 'side of the nose', 'nostrils',
                               'side of the nose', 'side of the lips 1', 'mouth', 'side of the lips 2',
                               'chin']
    elif category['name'] == 'hand':
        updated_point_names = ['wrist',
                               'base of the thumb ', 'part of the thumb 1', 'part of the thumb 2',
                               'part of the thumb 3', 'base of the index finger', 'part of the index finger 1',
                               'part of the index finger 2',  'part of the index finger 3',
                               'base of the finger', 'part of the finger 1',
                               'part of the finger 2', 'part of the finger 3',
                               'base of the ring finger', 'part of the ring finger 1',
                               'part of the ring finger 2', 'part of the ring finger 3',
                               'base of the pinky finger', 'part of the pinky finger 1',
                               'part of the pinky finger 2', 'part of the pinky finger 3'
                               ]
    elif category['name'] == 'locust':
        updated_point_names = ['head', 'neck', 'part 1', 'part 2', 'tail',
                               'tip of the antenna 1', 'base of the antenna 1', 'eye 1',
                               'leg 1', 'leg 2', 'leg 3', 'leg 4',
                               'leg 5', 'leg 6', 'leg 7', 'leg 8',
                               'leg 9', 'leg 10', 'leg 11', 'leg 12',
                               'tip of the antenna 2', 'base of the antenna 2', 'eye 2',
                               'leg 13', 'leg 14', 'leg 15', 'leg 16',
                               'leg 17', 'leg 18', 'leg 19', 'leg 20',
                               'leg 21', 'leg 22', 'leg 23', 'leg 24']

    elif category['name'] == 'fly':
        updated_point_names = ['head', 'eye 1', 'eye 2', 'neck', 'thorax', 'abdomen', 'leg',
                               'start point of the leg 1', 'point of the leg 1',
                               'almost the end point of the leg 1', 'end point of the leg 1',
                               'start point of the leg 2', 'point of the leg 2',
                               'almost the end point of the leg 2', 'end point of the leg 2',
                               'start point of the leg 3', 'point of the leg 3',
                               'almost the end point of the leg 3', 'end point of the leg 3',
                               'start point of the leg 4', 'point of the leg 4',
                               'almost the end point of the leg 4', 'end point of the leg 4',
                               'start point of the leg 5', 'point of the leg 5',
                               'almost the end point of the leg 5', 'end point of the leg 5',
                               'start point of the leg 6', 'point of the leg 6',
                               'almost the end point of the leg 6', 'end point of the leg 6',
                               'wing 1', 'wing 2']
    else:
        updated_point_names = category['keypoints']
        updated_point_names = [k.replace("_", " ") for k in updated_point_names]
