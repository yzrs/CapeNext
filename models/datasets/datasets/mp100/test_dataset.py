...
class TestPoseDataset(TestBaseDataset):
    ...
    def get_points_names_tokens(self):
        print("Tokenizing point names with {}.".format(self.modify_texts))
    ...
    def evaluate(self, outputs, res_folder, metric='PCK', **kwargs):
        ...
        # supcategory_info_str = self._report_supercategory_metric(res_file, metrics)
        # info_str.extend(supcategory_info_str)

        # category_info_str = self._report_category_metric(res_file, metrics)
        # info_str.extend(category_info_str)
